...
class NoteTabAndroid extends StatefulWidget {
  NoteTabAndroid({Key? key}) : super(key: key);

  @override
  State<NoteTabAndroid> createState() => _NoteTabAndroidState();
}

class _NoteTabAndroidState extends State<NoteTabAndroid> {
  @override
